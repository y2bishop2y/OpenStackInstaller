...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :controller do |controller_config|
    ...
    controller_config.vm.network :private_network, ip: "10.5.4.201", :netmask => "255.255.0.0"
  ...
  config.vm.define :compute do |compute_config|
    ...
    compute_config.vm.network :private_network, ip: "10.5.4.202",  :netmask => "255.255.0.0"
